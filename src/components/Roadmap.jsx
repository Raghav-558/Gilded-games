...
const Roadmap = () => {
  return (
    <>
      <div className='max-w-[1952px] mx-auto max-2xl:pl-4 pt-[92px] pb-[75px] max-lg:py-[60px] max-sm:py-10 overflow-hidden'>
                ...
                >
                  ...
                  <ul className='flex flex-col gap-3 pt-3 max-sm:pt-1 text-white/70 list-inside list-disc'>
                    {item.list.map((list, i) => (
                      <li
                        key={i}
                        className='text-lg max-sm:text-sm leading-[18.75px] font-normal font-montserrat'
                      >
                        {list}
                      </li>
                    ))}
